...
import img_wide from './img/photos/IMG_6016_2.jpg'
...
const Intro = () => {
  return (
    <section id="intro">
      ...
      <img className="img_wide" src={img_wide} alt="salon" />
      <div id="intro_photosFour">
        <img className="img_1-4" src={img_14_1} alt="salon" />
        <img className="img_1-4" src={img_14_2} alt="salon" />
        <img className="img_1-4" src={img_14_3} alt="salon" />
